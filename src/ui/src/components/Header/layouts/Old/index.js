...
import { useSession, useLanguage, useOrder, useEvent, useConfig, useCustomer } from '~components'
...
import {
  ...
  AddressFormOld as AddressForm,
  AddressListOld as AddressList,
  CartContentOld as CartContent,
  CartPopoverOld as CartPopover,
  HeaderOptionOld as HeaderOption,
  MomentControlOld as MomentControl,
  OrderTypeSelectorHeaderOld as OrderTypeSelectorHeader,
  SidebarMenuOld as SidebarMenu,
  UserDetailsOld as UserDetails,
  UserPopoverOld as UserPopover,
  MomentPopover,
  AddressesPopover,
  LoginForm,
  SignUpForm,
